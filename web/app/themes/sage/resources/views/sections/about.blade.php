        ...
        <div class="row gx-5 align-items-center">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="about-image position-relative">
              <img src="@asset('images/about/about-portrait-1.webp')" class="img-fluid rounded-4 shadow-sm" alt="About Image" loading="lazy">
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="client-info d-flex align-items-center mt-4">
                        <img src="@asset('images/person/person-f-1.webp')" class="client-img" alt="Client" loading="lazy">
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="client-info d-flex align-items-center mt-4">
                        <img src="@asset('images/person/person-m-1.webp')" class="client-img" alt="Client" loading="lazy">
                        <div>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="client-info d-flex align-items-center mt-4">
                        <img src="@asset('images/person/person-f-2.webp')" class="client-img" alt="Client" loading="lazy">
                        <div>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="client-info d-flex align-items-center mt-4">
                        <img src="@asset('images/person/person-f-3.webp')" class="client-img" alt="Client" loading="lazy">
                        <div>
